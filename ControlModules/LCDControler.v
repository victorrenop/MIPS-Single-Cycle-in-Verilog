...
module LCDControler(iCLK_50MHZ, iRST_N, neg, negIn, hex5, hex4, hex3, hex2, hex1, hex0, hexIn5, hexIn4, hexIn3, hexIn2, hexIn1, hexIn0, menu, LCD_RS,LCD_E,LCD_RW,DATA_BUS);

input iCLK_50MHZ, iRST_N, neg, negIn;
input [3:0]  hex5, hex4, hex3, hex2, hex1, hex0;
input [3:0]  hexIn5, hexIn4, hexIn3, hexIn2, hexIn1, hexIn0;
input [4:0] menu;
